...
export default function Card(props) {
  ...
  return (
    <div className="group relative md:pb-[50px] pb-[30px]">
          ...
          {props.content.rate_haft && props.content.rate <= 5 && (
            ...
            >
              ...
              <g mask="url(#mask0_2993_656)">
                <path
                  fill="#D3DCE5"
                  d="M8.471 -2H17.747999999999998V14H8.471z"
                ></path>
              </g>
            </svg>
          )}
      ...
      <h3 className="md:text-base text-sm leading-4 font-medium mb-2">
        <a className="group transition-all duration-300 ease-in-out" href="#/">
          <span className="bg-left-bottom bg-gradient-to-r from-black2 to-black2 bg-[length:0%_1px] bg-no-repeat hover:bg-[length:100%_1px] transition-all duration-300 ease-out">
            {props.content.title}
          </span>
        </a>
      </h3>
      <p className="md:text-base text-sm leading-5 font-semibold">
        <span className="text-gray line-through">
          {props.content.price_old}
        </span>{" "}
        {props.content.price}
      </p>
      <div className="mt-4">
