...
export default function Accordion() {
  ...
  return (
    <div className="border-t border-gray-light2">
      <div>
        <h3 onClick={() => openMenu(1)} className="flex justify-between items-center py-4 text-lg font-semibold">
          Description
          <span
            className={`md:hidden block transition-all duration-300 ${activeId === 1 ? `-rotate-180` : `rotate-0`}`}>
                      <svg
        ...
        <div
          className={`border-b border-solid border-gray-light2 overflow-hidden transition-all max-h-0 duration-500 ${activeId === 1 ? `max-h-full` : `max-h-0`}`}>
          <div className="pb-8">
            ...
            <p className="mb-8"><strong className="block text-lg font-semibold">Washing instructions:</strong>Machine
              wash,
              no ironing, don’t dry clean, don’t tumble dry and turn it upside down when drying to avoid color fading.
            </p>

            <p className="mb-8"><strong className="block text-lg font-semibold">Warranty & customer care:</strong>-
              Committed to product quality and design similar to the picture.<br/> - Guaranteed to be returned within 5
              days
              and item must be new and unused<br/>- Product is defective due to shipping and manufacturer</p>

            <p><small className="text-sm">Please note: The images shown may include colors that are not
              available.</small>
            </p>
          </div>
        </div>
      ...
      <div>
        <h3 onClick={() => openMenu(2)} className="flex justify-between items-center py-4 text-lg font-semibold">
          Additional information
          <span
            className={`md:hidden block transition-all duration-300 ${activeId === 2 ? `-rotate-180` : `rotate-0`}`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="12"
                        height="7"
        ...
        <div
          className={`border-b border-solid border-gray-light2 overflow-hidden transition-all max-h-0 duration-500 ${activeId === 2 ? `max-h-full` : `max-h-0`}`}>
          <div className="pb-8">
            <p className="mb-7">Round neck dress 85cm long, dear customers. The material of the product is soft and
              beautiful, and the nose
              is pretty standard, only a little extra. The 2-layer dress is super beautiful, with no wrinkles, no
              ruffles.
              The shop's women's goods are free-size, women's height m65 52kg in weight, it's beautiful. Designed with
              the
            ...
            <div className="max-w-[560px] mb-7">
              ...
              <p className="flex mb-2"><strong className="font-medium w-40 mr-10">Color</strong> Pink, white, red, black
              </p>
      ...
      <div>
        <h3 onClick={() => openMenu(3)} className="flex justify-between items-center py-4 text-lg font-semibold">
          Reviews
          <span
            className={`md:hidden block transition-all duration-300 ${activeId === 3 ? `-rotate-180` : `rotate-0`}`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="12"
                        height="7"
        ...
        <div
          className={`border-b border-solid border-gray-light2 overflow-hidden transition-all max-h-0 duration-500 ${activeId === 3 ? `max-h-full` : `max-h-0`}`}>
          <div className="pb-8">
            <div className="grid md:grid-cols-2 grid-cols-1 lg:gap-20 md:gap-10">
              <div>
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-[14px] md:mb-[47px] mb-8 max-w-[480px]">
                  ...
                  <Select options={star_options} defaultValue={star_options[0]} styles={customStyles}
                          components={{IndicatorSeparator: () => null}}/>
                </div>
                <div className="md:mb-10 mb-7">
                  <div className="mb-[30px] pb-[18px] border-b border-solid border-gray-light2">
                    ...
                    <div>
                      <p>Delivery is quite fast, ok, good seam, quality of shirt is suitable for price range, fabric
                        quality, I have to wear it to know because this is my first purchase, quite satisfied :")))</p>
                    </div>
                  </div>
                  <div className="mb-[30px] pb-[18px] border-b border-solid border-gray-light2">
                    <div className="flex justify-between">
              ...
              <div>
                ...
                <form>
                  ...
                  <div className="md:mt-0 mt-8">
                    <a href="#/"
                       className="inline-flex justify-center rounded-xl text-md font-semibold py-[10px] px-6 text-white bg-black2 border-2 border-solid border-black2 hover:bg-white hover:text-black2">Submit
                      Review</a>
                  </div>
                </form>
              </div>
