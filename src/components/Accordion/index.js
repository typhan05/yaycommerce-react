...
export default function Accordion() {
  ...
  return (
    <div className="border-t border-gray-light2">
      <div>
        <h3
          onClick={() => openMenu(1)}
          className="flex justify-between items-center py-4 text-lg font-semibold"
        >
          Description
          <span
            className={`md:hidden block transition-all duration-300 ${
              activeId === 1 ? `-rotate-180` : `rotate-0`
            }`}
          >
            <svg
        ...
        <div
          className={`border-b border-solid border-gray-light2 overflow-hidden transition-all max-h-0 duration-500 ${
            activeId === 1 ? `max-h-full` : `max-h-0`
          }`}
        >
          <div className="pb-8">
            <p className="mb-3">
              <strong className="block text-lg font-semibold">Overview:</strong>
              Short skirt with round neck has cotton double-layered, sexy
              figure, off-shoulder design, long-sleeve design, flared sleeves
              with pink and white stripes pattern.
            </p>
            ...
            <p className="mb-8">
              ...
              Machine wash, no ironing, don’t dry clean, don’t tumble dry and
              turn it upside down when drying to avoid color fading.
            </p>
            ...
            <p className="mb-8">
              ...
              - Committed to product quality and design similar to the picture.
              <br /> - Guaranteed to be returned within 5 days and item must be
              new and unused
              <br />- Product is defective due to shipping and manufacturer
            </p>

            <p>
              <small className="text-sm">
                Please note: The images shown may include colors that are not
                available.
              </small>
            </p>
          </div>
      ...
      <div>
        ...
        >
          ...
          <span
            className={`md:hidden block transition-all duration-300 ${
              activeId === 2 ? `-rotate-180` : `rotate-0`
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className={`border-b border-solid border-gray-light2 overflow-hidden transition-all max-h-0 duration-500 ${
            activeId === 2 ? `max-h-full` : `max-h-0`
          }`}
        >
          <div className="pb-8">
            <p className="mb-7">
              Round neck dress 85cm long, dear customers. The material of the
              product is soft and beautiful, and the nose is pretty standard,
              only a little extra. The 2-layer dress is super beautiful, with no
              wrinkles, no ruffles. The shop's women's goods are free-size,
              women's height m65 52kg in weight, it's beautiful. Designed with
              the same color as the photo: Female: height m65, weight 48kg,
              please wear it well.{" "}
            </p>
            <div className="max-w-[560px] mb-7">
              <p className="flex mb-2">
                <strong className="font-medium w-40 mr-10">Product ID</strong>{" "}
                #83518358539
              </p>
              <p className="flex mb-2">
                <strong className="font-medium w-40 mr-10">Material</strong>{" "}
                100% Cotton
              </p>
              <p className="flex mb-2">
                <strong className="font-medium w-40 mr-10">Color</strong> Pink,
                white, red, black
              </p>
              <p className="flex mb-2">
                <strong className="font-medium w-40 mr-10">Size</strong>{" "}
                Freesize
              </p>
              <p className="flex mb-2">
                <strong className="font-medium w-40 mr-10">
                  Jacket length
                </strong>{" "}
                114 cm
              </p>
              <p className="flex mb-2">
                <strong className="font-medium w-40 mr-10">Weight</strong> 450
                gr
              </p>
              <p className="flex mb-2">
                <strong className="font-medium w-40 mr-10">Other info</strong> -
              </p>
            </div>
            <p>
              Guarantee product as photo, return products in 7 days, fast
              service, quality is number 1.
              <br />
      ...
      <div>
        ...
        >
          ...
          <span
            className={`md:hidden block transition-all duration-300 ${
              activeId === 3 ? `-rotate-180` : `rotate-0`
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <div className="pb-8">
            <div className="grid md:grid-cols-2 grid-cols-1 lg:gap-20 md:gap-10">
                    ...
                    <div className="flex justify-between">
                      <div className="flex">
                        <div className="w-[44px] h-[44px] rounded-[22px] flex-shrink-0 mr-3">
                          <img
                            src={require("../../assets/images/image-avt.png")}
                            alt={"avt-img"}
                      ...
                      <p className="text-sm text-gray text-md">
                        May 19, 2022 - 19:30
                      </p>
                    </div>
                    <div>
                      <p>
                        Delivery is quite fast, ok, good seam, quality of shirt
                        is suitable for price range, fabric quality, I have to
                        wear it to know because this is my first purchase, quite
                        satisfied :")))
                      </p>
                    </div>
                  </div>
                  <div className="mb-[30px] pb-[18px] border-b border-solid border-gray-light2">
                    <div className="flex justify-between">
                      <div className="flex">
                        <div className="w-[44px] h-[44px] rounded-[22px] flex-shrink-0 mr-3">
                          <img
                            src={require("../../assets/images/img-avt-1.png")}
                            alt={"avt-img"}
                            className="object-center"
                          />
                        </div>
                  ...
                  <div className="mb-[30px] pb-[18px] border-b border-solid border-gray-light2">
                    <div className="flex justify-between">
                      <div className="flex">
                        <div className="w-[44px] h-[44px] rounded-[22px] flex-shrink-0 mr-3">
                          <img
                            src={require("../../assets/images/img-avt-3.png")}
                            alt={"avt-img"}
                            className="object-center"
                          />
                        </div>
                  ...
                  <div className="mb-[30px] pb-[18px] border-b border-solid border-gray-light2">
                    <div className="flex justify-between">
                      <div className="flex">
                        <div className="w-[44px] h-[44px] rounded-[22px] flex-shrink-0 mr-3">
                          <img
                            src={require("../../assets/images/img-avt-4.png")}
                            alt={"avt-img"}
                            className="object-center"
                          />
                        </div>
                  ...
                  <div className="mb-[30px] pb-[18px] border-b border-solid border-gray-light2">
                    <div className="flex justify-between">
                      <div className="flex">
                        <div className="w-[44px] h-[44px] rounded-[22px] flex-shrink-0 mr-3">
                          <img
                            src={require("../../assets/images/img-avt-5.png")}
                            alt={"avt-img"}
                            className="object-center"
                          />
                        </div>
              ...
              <div>
                <div className="lg:flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-bold lg:mb-0 mb-2">
                    Average score
                  </h3>
                ...
                <form>
                  ...
                  <div className="md:mt-0 mt-8">
                    <a
                      href="#/"
                      className="inline-flex justify-center rounded-xl text-md font-semibold py-[10px] px-6 text-white bg-black2 border-2 border-solid border-black2 hover:bg-white hover:text-black2"
                    >
                      Submit Review
                    </a>
                  </div>
            ...
            <div className="md:pt-5 pt-14 pb-5">
              <Pagination />
            </div>
          </div>
        </div>
