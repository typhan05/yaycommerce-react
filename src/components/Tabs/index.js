    ...
    <TabList>
      {data.map(({ heading, number }, i) => (
        <Tab key={i}>
          {heading}{" "}
          {number && (
            <span className="text-sm bg-gray-light2 px-2 py-[2px] ml-1 rounded-[50px]">
              {number}
            </span>
          )}
        </Tab>
    ...
    <TabPanel>
      <div className="pt-5 pb-20 border-b border-solid border-gray-light2">
        <p className="mb-3">
          ...
          Short skirt with round neck has cotton double-layered, sexy figure,
          off-shoulder design, long-sleeve design, flared sleeves with pink and
        ...
        <p className="mb-8">
          ...
          Machine wash, no ironing, don’t dry clean, don’t tumble dry and turn
          it upside down when drying to avoid color fading.
        </p>
        ...
        <p className="mb-8">
          ...
          <br /> - Guaranteed to be returned within 5 days and item must be new
          and unused
    ...
    <TabPanel>
      <div className="pt-5 pb-20 border-b border-solid border-gray-light2">
        <p className="mb-7">
          ...
          product is soft and beautiful, and the nose is pretty standard, only a
          little extra. The 2-layer dress is super beautiful, with no wrinkles,
          no ruffles. The shop's women's goods are free-size, women's height m65
          52kg in weight, it's beautiful. Designed with the same color as the
          photo: Female: height m65, weight 48kg, please wear it well.{" "}
        </p>
        <div className="max-w-[560px] mb-7">
          ...
          <p className="flex mb-2">
            <strong className="font-medium w-40 mr-10">Material</strong> 100%
            Cotton
          </p>
          <p className="flex mb-2">
          ...
          <p className="flex mb-2">
            <strong className="font-medium w-40 mr-10">Size</strong> Freesize
          </p>
          <p className="flex mb-2">
            <strong className="font-medium w-40 mr-10">Jacket length</strong>{" "}
            114 cm
          </p>
          <p className="flex mb-2">
            <strong className="font-medium w-40 mr-10">Weight</strong> 450 gr
          </p>
          <p className="flex mb-2">
        ...
        <p>
          Guarantee product as photo, return products in 7 days, fast service,
          quality is number 1.
          <br />
          ...
          <div>
            ...
            <div className="md:mb-10 mb-7">
              <div className="mb-[30px] pb-[18px] border-b border-solid border-gray-light2">
                ...
                <div>
                  <p>
                    Delivery is quite fast, ok, good seam, quality of shirt is
                    suitable for price range, fabric quality, I have to wear it
                    to know because this is my first purchase, quite satisfied
                    :")))
                  </p>
                </div>
              </div>
