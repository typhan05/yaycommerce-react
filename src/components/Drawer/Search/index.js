  ...
  return (
    <Transition.Root show={isSearchShowing} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={hide}>
        ...
        <div className="fixed inset-0 mt-[44px] overflow-hidden">
          <div className="pointer-events-none absolute inset-0">
            ...
            >
              <Dialog.Panel className="pointer-events-auto relative w-screen bg-white py-[15px]">
                      ...
                      <div className="relative">
                        <form onSubmit={handleSubmit}>
                          <div
                            ...
                            <button type="submit" onClick={hide} className="absolute right-[4px] top-[14px] text-gray mr-4 hover:text-black2">
                              <svg
                ...
                <div className="max-w-[950px] mx-auto py-[15px]">
                        ...
                        <form onSubmit={handleSubmit}>
                          <div
                            ...
                            <input
                              ...
                              value={name}
                              onChange={filter} name="search" placeholder="Search"/>
                            <button type="submit" onClick={hide} className="absolute right-[4px] top-[17px] text-gray mr-4 hover:text-black2">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
                                height="20"
                  ...
                  <div>
                    {trends.map((user) => (
                      <button key={user.id} className={`px-4 py-[5px] font-medium border border-solid border-transparent rounded-[7px] duration-300 hover:bg-white hover:border-black hover:shadow-[0_5px_15px_rgba(0,0,0,0.07)] mx-1 ${itemActive === user.id ? `bg-white border-black shadow-[0_5px_15px_rgba(0,0,0,0.07)]` : `bg-gray-light5`}`}>{user.name}</button>
                    ))}
                  </div>
                </div>
                </div>
