    ...
    <>
      <section className="md:mb-[100px] mb-20">
        <div className="container mx-auto">
          <div className="relative py-[30px] max-w-[550px] mx-auto after:inset-x-0 after:h-0.5 after:absolute after:md:top-1/2 after:top-[60px] af after:-translate-y-1/2 after:block after:rounded-lg after:bg-[rgba(211,220,229,0.5)]">
            <ol className="relative z-10 flex justify-between md:text-lg text-xs md:font-bold font-semibold text-gray">
              <li className="flex md:flex-row flex-col items-center justify-center p-3 bg-white">
                <span className="flex justify-center w-[30px] h-[30px] leading-[30px] text-white bg-green text-center rounded-full">
                  1
                </span>
                <span className="md:ml-2 md:mt-0 mt-1 text-black2">
                  {" "}
                  My cart{" "}
                </span>
              </li>
              ...
              <li className="flex md:flex-row flex-col items-center justify-center p-3 bg-white">
                <span className="flex justify-center w-[30px] h-[30px] leading-[30px] text-center bg-gray-light12 rounded-full">
                  2
                </span>
          ...
          <h1 className="md:text-4xl text-2xl md:font-bold font-semibold md:mb-9 mb-5">
            Shopping cart
          </h1>
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-[90px]">
            <div className="lg:col-span-8">
              <table className="table-auto w-full">
                <thead>
                  <tr className="md:table-row hidden">
                    <th
                      colSpan={2}
                      className="text-left px-2 py-4 border-b border-gray-light2"
                    >
                      Product
                    </th>
                    <th className="px-2 py-4 border-b border-gray-light2">
                      Price
                    </th>
                    <th className="px-2 py-4 border-b border-gray-light2">
                      Quality
                ...
                <tbody>
                  {products.map((product) => (
                    <tr
                      key={`tr-cart` + product.id}
                      className="md:table-row grid grid-cols-6"
                    >
                      <td className="px-2 md:py-4 pt-4 pb-1 md:border-b border-0 border-gray-light2 col-span-2">
                        <div className="h-[100px] md:w-[75px] w-[80px] bg-gray-light5 flex-shrink-0 overflow-hidden rounded-lg">
                          <img
                      ...
                      <td className="px-2 md:py-4 pt-4 pb-1 md:border-b border-0 border-gray-light2 col-span-4">
                        ...
                        <button className="md:hidden text-sm mt-2">
                          Remove
                        </button>
                      </td>
                      <td className="text-center px-2 md:py-4 pt-1 pb-4 border-b border-gray-light2 md:table-cell flex items-center col-span-2">
                        <p className="text-base text-black2 mx-5">
                          {product.price}
                        </p>
                      </td>
                      <td className="text-center px-2 md:py-4 pt-1 pb-4 border-b border-gray-light2 md:w-[140px] col-span-2">
              ...
              <div className="flex items-center justify-between py-[30px]">
                ...
                <button
                  type="button"
                  className="md:text-base text-sm font-semibold hover:text-white border-2 border-black2 hover:bg-black2 rounded-xl duration-300 px-5 py-2.5 text-center"
                >
                  Update Cart
                </button>
              </div>
            ...
            <div className="md:mt-0 mt-10 bg-gray-light12 rounded-lg px-4 py-6 sm:p-6 lg:p-8 lg:mt-0 lg:col-span-4">
              ...
              <div className="pb-5 mb-5 border-b border-gray-light2">
                <p className="flex justify-between mb-2">
                  <span>Your cart</span> $425.18
                </p>
                <p className="flex justify-between">
                  <span>
                    Discount
                    <strong className="inline-flex items-center ml-3">
                      HAPPY20
              ...
              <div className="text-gray pb-5 mb-5 border-b border-gray-light2">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  >
                    <span className="w-[18px] h-[18px] inline-block mr-2 rounded-full border border-grey"></span>
                    Flat rate shipping to <strong>&nbsp;CA.</strong>
                  </label>
                  <span>$16.75</span>
                </div>
                <button
                  className="text-sm text-green mb-3 relative inline-block after:h-[1px] after:left-0 after:right-full after:bottom-0 after:absolute after:bg-green after:transition-all after:duration-300 after:ease-in-out hover:after:right-0"
                  onClick={openAddress}
                >
                  Change Address
                </button>
                <div
                  className={`rounded-[9px] shadow-[0_1px_2px_rgba(0,0,0,0.12)] bg-white py-5 px-6 mb-6 ${
                ...
                >
                  ...
                  <div className="mb-5">
                    <label
                      ...
                      className="block mb-2 text-sm font-medium"
                    >
                      Zip code<span className="text-pink">*</span>
                    </label>
                    <input
                      type="text"
                      id="first-name"
                ...
                <div className="flex items-center bg-white rounded-[9px] p-1 shadow-[0_1px_2px_rgba(0,0,0,0.12)] mb-4">
                  <input
                    className="bg-bg-white appearance-none w-full py-2 px-[15px] text-gray-700 leading-tight focus:outline-none focus:border-purple-500"
                    id="inline-full-name"
                    defaultValue="Happy20"
                    type="text"
                ...
                <div className="text-sm">
                  <p className="flex items-center text-green mb-1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                    ...
                    <span className="font-semibold">HAPPY20&nbsp;</span> has
                    been applied to your order!
                  </p>
                  <button className="text-gray relative inline-block after:h-[1px] after:left-0 after:right-full after:bottom-0 after:absolute after:bg-gray after:transition-all after:duration-300 after:ease-in-out hover:after:right-0">
                    Remove
                  </button>
                </div>
              </div>
              <div>
                ...
                <p>
                  <a
                    href="#/"
                    className="flex items-center justify-center rounded-xl border border-transparent shadow-[0_7px_25px_rgba(55,126,98,0.2)] bg-green px-6 py-3 text-lg font-semibold text-white duration-300 hover:bg-indigo-700 hover:bg-black2 hover:shadow-[0_7px_35px_rgba(0,0,0,0.1)"
                  >
                    Proceed to Checkout
                  </a>
                </p>
