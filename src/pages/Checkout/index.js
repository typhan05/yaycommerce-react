    ...
    <>
      <section className="md:mb-[100px] mb-20">
        <div className="container mx-auto">
          <div className="relative py-[30px] max-w-[550px] mx-auto after:inset-x-0 after:h-0.5 after:absolute after:top-1/2 after:-translate-y-1/2 after:block after:rounded-lg after:bg-[rgba(211,220,229,0.5)]">
            <ol className="relative z-10 flex justify-between md:text-lg text-base md:font-bold font-semibold text-gray">
              <li className="flex items-center justify-center p-3 bg-white">
                <span className="flex justify-center items-center w-[30px] h-[30px] leading-[30px] bg-black2 text-center rounded-full">
                  <svg
                ...
                <span className="ml-2 md:text-lg text-[0px] text-black2">
                  {" "}
                  My cart{" "}
                </span>
              </li>
              ...
              <li className="flex items-center justify-center p-3 bg-white">
                <span className="flex justify-center items-center w-[30px] h-[30px] leading-[30px] text-white bg-green text-center rounded-full">
                  2
                </span>
              ...
              <li className="flex items-center justify-center p-3 bg-white">
                <span className="flex justify-center items-center w-[30px] h-[30px] leading-[30px] text-center bg-gray-light12 rounded-full">
                  3
                </span>
          ...
          <h1 className="md:text-4xl text-2xl md:font-bold font-semibold md:mb-9 mb-4">
            Checkout
          </h1>
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-[90px]">
              ...
              <form>
                ...
                <div className="md:mb-7 mb-6">
                  <label
                    ...
                    className="block mb-2 text-sm font-medium"
                  >
                    Street address<span className="text-pink">*</span>
                  </label>
                  <input
                    type="text"
                    id="street"
            ...
            <div className="mt-[30px] mt-10 lg:mt-0 lg:col-span-5">
              <div className="bg-gray-light12 rounded-lg md:px-[30px] md:py-6 p-5 mb-[30px]">
                  ...
                  <div className="flex justify-between text-sm mb-4">
                    <div>
                      <p className="font-medium">
                        Wide Strap Seamless Sports Bra
                      </p>
                ...
                <div className="pb-2 mb-5 border-b border-gray-light2">
                  <p className="flex justify-between mb-3">
                    <span>Subtotal</span> $425.18
                  </p>
                  <p className="flex justify-between mb-3">
                    <span>
                      Discount
                  ...
                  <p className="flex justify-between mb-3">
                    <span>Taxes (estimated)</span> $7.59
                  </p>
                  <p className="flex justify-between mb-3">
              ...
              <div className="border border-gray-light9 rounded-xl">
                {optionPayments.map((e, i) => {
                  return (
                    <div
                      key={`card-pay` + i}
                      className="md:px-[30px] md:py-6 p-5 border-b border-gray-light9 last:border-b-0"
                    >
                      <input
                        id={`radioCredit+${i}`}
                        type="radio"
                      ...
                      <div className={`${activeId === i ? `block` : "hidden"}`}>
                        <p className="mt-4 mb-5 leading-[1.625rem]">
                          Your card information is secure! The card's data is
                          only for processing your order. Remit will not have
                          access to your card information.
                        </p>
                        <div className="md:mb-6 mb-5">
                          <label
                            htmlFor="card-number"
                            className="block mb-2 text-sm font-medium bg-red"
                          >
                            Card number
                        ...
                        <div className="md:grid md:grid-cols-2 gap-7">
                          ...
                          <div className="md:mb-0 mb-5">
                            <label
                              ...
                              className="block mb-2 text-sm font-medium"
                            >
                              CVV Address<span className="text-pink">*</span>
                            </label>
                            <input
                              type="text"
                              id="cvv"
