    ...
    <>
      <section className="lg:mb-[150px] lg:pt-[50px] pt-10 md:mb-20 mb-10">
        <div className="container mx-auto">
          <div className="lg:grid flex lg:grid-cols-12 lg:gap-x-12 flex-col-reverse lg:items-start xl:gap-x-[30px] lg:mb-[130px] mb-[60px]">
            <div className="lg:col-span-9 lg:mb-0 lg:mt-0 mt-5 mb-9 xl:pr-[90px]">
