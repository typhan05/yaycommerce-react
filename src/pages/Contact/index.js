        ...
        <div className="container mx-auto">
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-[120px]">
            <div className="lg:col-span-7">
              <h1 className="md:text-4xl text-[28px] font-bold mb-2">We’re here to help you!</h1>
              <div className="lg:mb-8 mb-5">
                <p className="text-gray">Have a question, comment, or brilliant idea you'd like to share? Please contact Remit using the most convenient way below:</p>
              </div>
              <div className="lg:mb-8 mb-5">
                <p className="mb-[15px]"><strong>Call us today:</strong><a href="tel:6-146-389-574">6-146-389-574</a></p>
                <p><strong>Send us an email:</strong><a href="mailto:support@remit.com">support@remit.com</a></p>
              </div>
              <form>
                <p className="mb-[15px]">Or fill out the form below and we’ll get back to you as soon as possible.</p>
