...
const questionLists = [
  {
    ...
    description:
      "We’ll cover duty costs on all orders. Additional taxes may apply according to local legislation. Please note the USA Express Free Shipping service cannot be used for International. If you have any further questions related to your delivery, please contact our Customer Care team.",
  },
  {
        ...
        <div className="container mx-auto">
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-[120px]">
            <div className="lg:col-span-4">
              <ul className="lg:mb-0 mb-6">
                <li className="group mb-[10px]">
                  <a
                    href="#/"
                    className="flex justify-between items-center rounded-[10px] bg-gray-light2 px-4 py-3 text-lg group-hover:bg-gray-light14"
                  >
                    Top 9 questions
                    <svg
                ...
                <li className="group mb-[10px]">
                  <a
                    href="#/"
                    className="flex justify-between items-center rounded-[10px] bg-gray-light13 px-4 py-3 text-lg group-hover:bg-gray-light14"
                  >
                    About Remit's delivery
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="8"
                      height="14"
            ...
            <div className="lg:col-span-8">
              <h1 className="md:text-4xl text-[28px] font-bold md:mb-[50px] mb-5">
                Top 9 questions
              </h1>
              <div className="md:mb-[90px] mb-10">
                {questionLists.map((item, i) => {
                  return (
                    <div
                      key={`faq-item` + i}
                      className="first:border-t border-b border-gray-light2"
                    >
                      <h3
                        className="cursor-pointer flex items-center justify-between text-lg font-semibold py-[18px]"
                        onClick={() => openCollapse(i)}
                      >
                        {item.title}
                        {activeId === i ? (
                          <svg
                      ...
                      <div
                        className={`relative transition-all duration-500 ${
                          activeId === i
                            ? `overflow-visible max-h-50 opacity-100 -top-2`
                            : `overflow-hidden max-h-0 opacity-0 top-4`
                        }`}
                      >
              ...
              <h2 className="md:text-4xl text-[28px] font-bold mb-4">
                Can we help?
              </h2>
              <div className="mb-8">
                <p className="text-gray">
                  If you have any specific questions please do not hesitate to
                  contact us by completing this form bellow or calling our
                  customer services team on hotline:{" "}
                  <a href="tel:+6-146-389-574" className="text-black2">
                    +6-146-389-574
                  </a>
                </p>
              </div>
